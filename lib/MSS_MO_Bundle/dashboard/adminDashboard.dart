...
class Admin_MSS_MO_Dashboard extends StatefulWidget {
  final DashboardModel dashboardModel1;

  const Admin_MSS_MO_Dashboard(this.dashboardModel1, {super.key});

  @override
  State<Admin_MSS_MO_Dashboard> createState() =>
      _Admin_MSS_MO_DashboardState(dashboardModel1);
}
...
class _Admin_MSS_MO_DashboardState extends State<Admin_MSS_MO_Dashboard> {
  final DashboardModel dashboardModel1;

  _Admin_MSS_MO_DashboardState(this.dashboardModel1);
  int? empRole;
  int? roRole;
  int? adminRole;
  var dateController;
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    ...
                    child:
                        isLoading
                            ? CircularProgressIndicator().centered().py1()
                            : oldEventLength == null
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child:
                        isLoading
                            ? CircularProgressIndicator().centered().py8()
                            : oldJobLength == null
                            ? "There is no data available.".text.center
                                .make()
                                .py16()
