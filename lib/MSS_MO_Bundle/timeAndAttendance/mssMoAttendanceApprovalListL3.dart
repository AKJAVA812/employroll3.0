...
class MSS_MO_Att_PendingRequisitionL3 extends StatefulWidget {
  final PendingRequisitionModel pendingRequisitionModel;
  MSS_MO_Att_PendingRequisitionL3 (this.pendingRequisitionModel);

  @override
  State<MSS_MO_Att_PendingRequisitionL3> createState() => _MSS_MO_Att_PendingRequisitionL3State(pendingRequisitionModel);
}
...
class _MSS_MO_Att_PendingRequisitionL3State extends State<MSS_MO_Att_PendingRequisitionL3> with RouteAware{
  final PendingRequisitionModel pendingRequisitionModel;
  _MSS_MO_Att_PendingRequisitionL3State(this.pendingRequisitionModel);
    ...
    return RefreshIndicator(
      onRefresh: () {
        Navigator.pushReplacement(
            ...
            PageRouteBuilder(
              pageBuilder: (a, b, c) =>
                  MSS_MO_Att_PendingRequisitionL3(PendingRequisitionModel()),
