...
class MSS_MO_OthersLeaveReqPage extends StatefulWidget {
  const MSS_MO_OthersLeaveReqPage({Key? key}) : super(key: key);

  @override
  State<MSS_MO_OthersLeaveReqPage> createState() =>
      _MSS_MO_OthersLeaveReqPageState();
}
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () async {
                          ...
                          Future<LeaveBalanceModel?> getLeaveType12 =
                              getLeaveTypeList(sessionId!);
                          final loading = Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: <Widget>[
                              CircularProgressIndicator(),
                ...
                Padding(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (newVal) {
                      ...
                      var leaveTypeId =
                          leaveBalanceLabel?.leaveTypeListDetails?[i].leaveId;
