...
class MSS_MO_LevelTwoPendingLeave extends StatefulWidget {
  ...
  @override
  State<MSS_MO_LevelTwoPendingLeave> createState() => _MSS_MO_LevelTwoPendingLeaveState(pendingLeaveRequisitionModal);
}
...
class _MSS_MO_LevelTwoPendingLeaveState extends State<MSS_MO_LevelTwoPendingLeave> with RouteAware {
  final LevelTwoPendingLeaveModal pendingLeaveRequisitionModal;
        ...
        child: SafeArea(
          child: Container(
            ...
            child: AnimationSearchBar(
              ...
              centerTitle: "$titleName - ${foundDataNewMOL2!.length}",
                verticalPadding: 3,
