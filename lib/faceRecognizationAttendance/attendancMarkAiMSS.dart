...
class MarkAttendanceAIMSS extends StatefulWidget {
  ...
  @override
  State<MarkAttendanceAIMSS> createState() => _MarkAttendanceAIMSSState(
    empId.toString(),
    empName.toString(),
    empFace.toString(),
  );
              ...
              children: [
                Card(
                  child: ListTile(
                    ...
                    title:
                        value == 1 ? Text(empNameReceived) : Text(selfEmpName),
                    ...
                    leading: Container(
                      child: CircleAvatar(
                        ...
                        backgroundImage:
                            value == 1
                                ? NetworkImage(empFaceReceived!)
                                : NetworkImage(selfEmpPhoto!),
