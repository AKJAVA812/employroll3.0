...
import 'attendancMarkAiMSS.dart';
import 'faceEmpListModalClass.dart';

class EmpListFaceRecognize extends StatefulWidget {
  const EmpListFaceRecognize({Key? key}) : super(key: key);

  static const String _title = 'Employee List';

  @override
  State<EmpListFaceRecognize> createState() => _EmpListFaceRecognizeState();
}
...
class _EmpListFaceRecognizeState extends State<EmpListFaceRecognize> {
  ...
  Future getSharedPrfanceList() async {
    ...
    Future<EmployeeListFaceModel> getEmployeeList11 = getEmployeeList(
      sessionId!,
    );
    final loading = Row(
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, i) {
        return InkWell(
          onTap: () {
            if (foundDataNew![i].face == false) {
              Fluttertoast.showToast(
                msg: "Face is not registered, Please register the face !",
            ...
            child: ListTile(
              ...
              subtitle: Column(
                ...
                children: [
                  Row(
                    children: [
                      foundDataNew![i].empCode.toString().text.make().py4(),
                    ],
                  ),
                  /* Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
