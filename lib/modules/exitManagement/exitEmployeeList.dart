...
class ExitEmployeeListView extends StatefulWidget {
  ...
  @override
  State<ExitEmployeeListView> createState() => _ExitEmployeeListViewState();
}
...
class _ExitEmployeeListViewState extends State<ExitEmployeeListView>
  ...
  Future<void> initiateExitProcess(String empId) async {
    String conn = ApiDetails.server;
  ...
  Future<void> unInitiateExitProcess(String empId) async {
    String conn = ApiDetails.server;
    String apiUrl = ApiDetails.initiateExitApi;
    CommonNotificationPage.showLoaderDialog(context);
    var urlapi = Uri.parse(
