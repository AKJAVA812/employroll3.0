...
class _ExitWorkflowState extends State<ExitWorkflow> {
  ...
  final TextEditingController noticePeriodDaysController = TextEditingController();
            ...
            child: SingleChildScrollView(
                          ...
                          Radio(
                            ...
                            onChanged: (value) {
                              setState(() {
                                ...
                                radiosNoticePeriodCheck = value.toString();
                              });
                            },
                          ),
              ...
              labelStyle: TextStyle(
                ...
                color: Mythemes.blackish,
                        ...
                        items: separationList.map<DropdownMenuItem<String>>((String? value) {
...
// Add static fields
    ...
    request.files.add(await http.MultipartFile.fromPath('document', uploadedFile!.path,));
