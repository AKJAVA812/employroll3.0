...
import 'package:er_flutter_project/modules/preInductionOnboarding/preInductionProcess.dart';
...
class PreOnboardListView extends StatefulWidget {
  ...
  @override
  State<PreOnboardListView> createState() => _PreOnboardListViewState();
}
                ...
                return RefreshIndicator(
                  onRefresh: () {
                    Navigator.pushReplacement(
                      context,
                      PageRouteBuilder(
                        pageBuilder: (a, b, c) => PreOnboardListView(),
                        transitionDuration: Duration(seconds: 1),
                        maintainState: true,
                      ),
                    );
