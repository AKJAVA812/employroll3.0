...
class ApprovePreOnboarding extends StatefulWidget {
  ...
  ApprovePreOnboarding(this.typeOfHiring, this.aadharNo, this.fullName, this.dob, this.doj, this.contactNo,
      this.inHandSalary, this.accomodationCheck, this.aadharCardFront, this.aadharCardBack, this.panCard, this.empPhoto, this.idCheck,
      this.branchName, this.departmentName, this.designationName, this.bankName, this.accountNo, this.ifscCode,
  this.nomineeName, this.nomineeAadhar, this.nomineeRelation);
  ...
  State<ApprovePreOnboarding> createState() => _ApprovePreOnboardingState(
    typeOfHiring, aadharNo, fullName, dob, doj, contactNo,
    inHandSalary, accomodationCheck, aadharCardFront,aadharCardBack, panCard, empPhoto, idCheck,
      branchName, departmentName, designationName, bankName, accountNo, ifscCode,
      nomineeName, nomineeAadhar, nomineeRelation
  );
}
          ...
          content: Container(
            ...
            child: isPdf
              ...
              errorBuilder: (context, error, stackTrace) {
                return Center(
                  child: Text("There is no document added.", style: TextStyle(color: Colors.red)),
                );
              },
            ),
          ),
  ...
  Widget build(BuildContext context) {
    ...
    return DismissKeyboard(
      child: Scaffold(
        appBar: AppBar(
          actions: [
            "${fullNameController.text}".text.size(14).bold.color(Mythemes.dangerColor).make().px(10)
          ],
                            ...
                            child: Expanded(
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    suffixIcon: IconButton(onPressed: () {}, icon: Icon(Icons.check_circle, size: 22, color: Mythemes.successColor,))
                                ),
                              ).p8(),
                                      ...
                                      if (fileUrl.isEmpty) {
                                        ...
                                        if (['pdf'].contains(ext)) {
                                          ...
                                          showDialog(
                                            context: context,
                                            builder: (_) => AlertDialog(
                                              content: Image.network(fileUrl, fit: BoxFit.contain),
                                              actions: [
                                                TextButton(
                                                  onPressed: () {
                                                    if (Navigator.of(context).canPop()) { // ✅ Using `context` inside the builder
