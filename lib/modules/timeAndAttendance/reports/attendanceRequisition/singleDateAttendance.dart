...
class SingleDateAttendance extends StatefulWidget {
  ...
  const SingleDateAttendance(
      {Key? key, required this.singleDateString,})
      : super(key: key);

  @override
  State<SingleDateAttendance> createState() => _SingleDateAttendanceState(singleDateString);
}
...
class _SingleDateAttendanceState extends State<SingleDateAttendance> with RouteAware{
  final String singleDateString;
...
class _AttListState extends State<AttList> {
  ...
  @override
  Widget build(BuildContext context) {
    String dateFormate = DateFormat("dd-MM-yyyy").format(DateTime.parse(onDateAttModelGlobel!.date!.toString()));
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              onDateAttModelGlobel!.inTime! == "Govardhan Puja" ? "G P".text.sm.make() :
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              onDateAttModelGlobel!.outTime! == "Govardhan Puja" ? "G P".text.sm.make() :
