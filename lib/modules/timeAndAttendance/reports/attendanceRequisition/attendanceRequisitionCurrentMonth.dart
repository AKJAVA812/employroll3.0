...
class AttendanceRequestCurrentMonth extends StatefulWidget {
  ...
  @override
  State<AttendanceRequestCurrentMonth> createState() =>
...
class _AttendanceRequestCurrentMonthState
    extends State<AttendanceRequestCurrentMonth>
    with RouteAware {
  AttendanceReportModel? attendanceModelGlobel;
  OnDateAttModel? onDateAttModel;
  int indexCont;
  ...
  void initState() {
    ...
    if (attendanceModelGlobel != null) {
      ...
      updatedWorkHourSet =
          attendanceModelGlobel!.data![indexCont].updatedWorkingHour;
      relaxationHourSet =
          attendanceModelGlobel!.data![indexCont].relaxationHour;
      isShortLeave =
          attendanceModelGlobel!.data![indexCont].isShortLeave ?? isShortLeave;
      ...
      shiftWorkingHourSet =
          attendanceModelGlobel!.data![indexCont].shiftWorkingHour;
      departmentset = attendanceModelGlobel!.data![indexCont].departmentName;
      employeeNameset = attendanceModelGlobel!.data![indexCont].employeeName;
      onDateset = attendanceModelGlobel!.data![indexCont].attendanceDate;
      actualTimeset = attendanceModelGlobel!.data![indexCont].inTime;
