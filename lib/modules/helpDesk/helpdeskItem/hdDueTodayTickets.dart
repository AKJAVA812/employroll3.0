...
class HDDueTodayTickets extends StatefulWidget {
  const HDDueTodayTickets({Key? key}) : super(key: key);

  @override
  State<HDDueTodayTickets> createState() => _HDDueTodayTicketsState();
}

class _HDDueTodayTicketsState extends State<HDDueTodayTickets> {
  @override
  Widget build(BuildContext context) {
    var titleName = "Due Today Tickets";
    return Scaffold(
        appBar: AppBar(
