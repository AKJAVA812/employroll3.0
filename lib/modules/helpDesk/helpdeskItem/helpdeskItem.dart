...
class _HelpDeskItemsState extends State<HelpDeskItems> {
  ...
  Future getSharedPrfanceList() async {
    ...
    Future<DepartmentListModal> getEmployeeList13 = getDepartmentList(sessionId!);
  ...
  Future<SubQueryTypeListModal> getSubQueryTypeList(String sessionId) async {
    ...
    for(int i=0; i<mapResponseSubQuery['statusdata'].length;i++){
      subQueryTypeList.add(mapResponseSubQuery['statusdata'][i]['subQueryname']);
  ...
  void _runFilter(String enteredKeyword) {
    ...
    if (enteredKeyword.isEmpty) {
      ...
      results = allUsernew?.where((element) =>
          element.ticketNo!.toLowerCase().contains(enteredKeyword.toLowerCase())).toList();
                      ...
                      Card(
                        ...
                        child: InkWell(
                          onTap: () {
                            ...
                            print("m innocent" "$raiseTicketShow");
                              ...
                              Center(
                                child: Container(
                                  ...
                                  child: Text(
                                    ...
                                    maxLines: 1,
                                    style: TextStyle(
                                        color: Mythemes.blackish, fontSize: 12),
                                  ),
                                ),
                              ),
                            ],
                  ...
                  child: Expanded(
                    child: SingleChildScrollView(
                            ...
                            Row(
                              children: [
                                Expanded(
                                  ...
                                  for(int i=0; i<mapResponse['data'].length;i++){
                                    if(mapResponse['data'][i]['deptName'].toString().compareToIgnoringCase(newVal.toString()) ==0)
                                    {
                                      deptId = mapResponse['data'][i]['branchDeptId'];
                                      subject = mapResponse['data'][i]['deptName'];
                      ...
                      setState(() {
                        ...
                        Future<QueryTypeListModal> getSubLocation = getQueryTypeList(sessionId!);
                              ...
                              children: [
                                Expanded(
                                  child: DropdownButtonFormField(
                                      ...
                                      items: queryTypeList.map<DropdownMenuItem<String>>((String? value) {
                                        return DropdownMenuItem<String>(
                                          value: value,
                                          child: Text(value! , style: TextStyle(fontSize: 9), maxLines: 2),
                                        );
                                    ...
                                    onChanged: (newVal) {
                                      ...
                                      //int i =workTypeList.indexOf(valuenew);
                                      for(int i=0; i<mapResponseQuery['statusdata'].length;i++){
                                        if(mapResponseQuery['statusdata'][i]['description'].toString().compareToIgnoringCase(newVal.toString()) ==0)
                                        {
                                          queryTypeId = mapResponseQuery['statusdata'][i]['id'];
                                      ...
                                      setState(() {
                                        ...
                                        Future<SubQueryTypeListModal> getSubQuery = getSubQueryTypeList(sessionId!);
                              ...
                              children: [
                                Expanded(
                                  child: DropdownButtonFormField(
                                      ...
                                      items: subQueryTypeList.map<DropdownMenuItem<String>>((String? value) {
                                        return DropdownMenuItem<String>(
                                          value: value,
                                          child: Text(value! , style: TextStyle(fontSize: 9), maxLines: 2),
                                        );
                                    ...
                                    onChanged: (newVal) {
                                      ...
                                      //int i =workTypeList.indexOf(valuenew);
                                      for(int i=0; i<mapResponseSubQuery['statusdata'].length;i++){
                                        if(mapResponseSubQuery['statusdata'][i]['description'].toString().compareToIgnoringCase(newVal.toString()) ==0)
                                        {
                                          subQueryTypeId = mapResponseSubQuery['statusdata'][i]['id'];
                                          print("Id -  $subQueryTypeId");
                                        }
                                        ...
                                        child: Container(
                                          child: Column(
                                            children: [
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          foundDataNew![i].ticketNo.toString()
                                                              .text
                                                              .textStyle(
                                                  ...
                                                  Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          foundDataNew![i].queryStatusName.toString()
                                                              .text
                                                              .color(Mythemes
                                                              .lightBluishColor)
                                                              .sm
                                              ...
                                              Row(
                                                children: [
                                                  Expanded(child: foundDataNew![i].subject.toString()
                                                      .text.size(13).maxLines(2).ellipsis
                                                      .make()
                                                      .px8(),),
                                                  ...
                                                  Expanded(
                                                      child: Column(
                                                        ...
                                                        MainAxisAlignment.end,
                                                        children: [
                                                          foundDataNew![i].timeAgo.toString()
                                                              .text
                                                              .textStyle(
                                                              context.captionStyle)
                                                              .make().px8(),
                                              ...
                                              Row(
                                                children: [
                                                  foundDataNew![i].creationDate.toString().text.make().px8(),
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    Navigator.pushNamed(context, MyRoutings.hdOpenTicketRoute);
                                  },
                                  child: Card(
                                    elevation: 4,
                                    child: Container(
                                          ...
                                          Column(
                                            children: [
                                              Row(
                                                ...
                                                children: [
                                                  "Open".text.bold.overflow(TextOverflow.ellipsis).maxLines(1).size(16).color(Mythemes.lightBluishColor).make().py12().px8(),
                                                  Container(
                                                      child: "120".text.xl2.bold.color(Mythemes.lightBluishColor).make()
                                                  ).px8()
                                                ],
                                              ),
                                              Row(
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    Navigator.pushNamed(context, MyRoutings.hdOverdueTicketRoute);
                                  },
                                  child: Card(
                                    elevation: 4,
                                    child: Container(
                                          ...
                                          Column(
                                            children: [
                                              Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: [
                                                  "Overdue".text.bold.overflow(TextOverflow.ellipsis).maxLines(1).size(16).color(Mythemes.dangerColorOne).make().py12().px8(),
                                                  Container(
                                                      child: "101".text.xl2.bold.color(Mythemes.dangerColorOne).make()
                                                  ).px8()
                                                ],
                                              ),
                                              Row(
                                                children: [
                                                  new LinearPercentIndicator(
                                                    ...
                                                    percent: 0.45,
                                                    backgroundColor: Mythemes.greyishade,
                                                    progressColor: Mythemes.dangerColor,
                                                  ),
                                                ],
                                              ).py16(),
                                            ],
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    Navigator.pushNamed(context, MyRoutings.hdDueTodayTicketRoute);
                                  },
                                  child: Card(
                                    elevation: 4,
                                    child: Container(
                                          ...
                                          Column(
                                            children: [
                                              Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: [
                                                  "Due Today".text.bold.overflow(TextOverflow.ellipsis).maxLines(1).size(16).color(Mythemes.alertColor).make().py12().px8(),
                                                  Container(
                                                      child: "26".text.xl2.bold.color(Mythemes.alertColor).make()
                                                  ).px8()
                                                ],
                                              ),
                                              Row(
                                                children: [
                                                  new LinearPercentIndicator(
                                                    ...
                                                    percent: 0.18,
                                                    backgroundColor: Mythemes.greyishade,
                                                    progressColor: Mythemes.alertColor,
                                                  ),
                                                ],
                                              ).py16(),
                                            ],
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    Navigator.pushNamed(context, MyRoutings.hdOnHoldTicketRoute);
                                  },
                                  child: Card(
                                    elevation: 4,
                                    child: Container(
                                          ...
                                          Column(
                                            children: [
                                              Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: [
                                                  "On Hold".text.bold.overflow(TextOverflow.ellipsis).maxLines(1).size(16).color(Mythemes.warningColor).make().py12().px8(),
                                                  Container(
                                                      child: "210".text.xl2.bold.color(Mythemes.warningColor).make()
                                                  ).px8()
                                                ],
                                              ),
                                              Row(
                                                children: [
                                                  new LinearPercentIndicator(
                                                    ...
                                                    percent: 0.55,
                                                    backgroundColor: Mythemes.greyishade,
                                                    progressColor: Mythemes.warningColor,
                                                  ),
                                                ],
                                              ).py16(),
                                            ],
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    Navigator.pushNamed(context, MyRoutings.hdNewTicketRoute);
                                  },
                                  child: Card(
                                    elevation: 4,
                                    child: Container(
                                          ...
                                          Column(
                                            children: [
                                              Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: [
                                                  "New Ticket".text.bold.overflow(TextOverflow.ellipsis).maxLines(1).size(16).color(Mythemes.alertColor).make().py12().px8(),
                                                  Container(
                                                      child: "126".text.xl2.bold.color(Mythemes.alertColor).make()
                                                  ).px8()
                                                ],
                                              ),
                                              Row(
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    Navigator.pushNamed(context, MyRoutings.hdReOpenTicketRoute);
                                  },
                                  child: Card(
                                    elevation: 4,
                                    child: Container(
                                          ...
                                          Column(
                                            children: [
                                              Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: [
                                                  "Re-open".text.bold.overflow(TextOverflow.ellipsis).maxLines(1).size(16).color(Mythemes.lightBluishColor).make().py12().px8(),
                                                  Container(
                                                      child: "40".text.xl2.bold.color(Mythemes.lightBluishColor).make()
                                                  ).px8()
                                                ],
                                              ),
                                              Row(
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    Navigator.pushNamed(context, MyRoutings.hdResolvedTicketRoute);
                                  },
                                  child: Card(
                                    elevation: 4,
                                    child: Container(
                                          ...
                                          Column(
                                            children: [
                                              Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: [
                                                  "Resolved".text.bold.overflow(TextOverflow.ellipsis).maxLines(1).size(16).color(Mythemes.successColor).make().py12().px8(),
                                                  Container(
                                                      child: "86".text.xl2.bold.color(Mythemes.successColor).make()
                                                  ).px8()
                                                ],
                                              ),
                                              Row(
                                                children: [
                                                  new LinearPercentIndicator(
                                                    ...
                                                    percent: 0.45,
                                                    backgroundColor: Mythemes.greyishade,
                                                    progressColor: Mythemes.successColor,
                                                  ),
                                                ],
                                              ).py16(),
                                            ],
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    Navigator.pushNamed(context, MyRoutings.hdCancelledTicketRoute);
                                  },
                                  child: Card(
                                    elevation: 4,
                                    child: Container(
                                          ...
                                          Column(
                                            children: [
                                              Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: [
                                                  "Cancelled".text.bold.overflow(TextOverflow.ellipsis).maxLines(1).size(16).color(Mythemes.dangerColor).make().py12().px8(),
                                                  Container(
                                                      child: "210".text.xl2.bold.color(Mythemes.dangerColor).make()
                                                  ).px8()
                                                ],
                                              ),
                                              Row(
  ...
  async {
    ...
    var uri = Uri.parse("http://super.employroll.com:8081/employroll/api/third/party/org/raised/query/details/saved/mobile");
  ...
  /*  String jsonString = createJsonWithImage(imageValue);
    ...
    if (response.statusCode == 200) {
      ...
      if(result.compareToIgnoringCase("success")==0){
        CommonNotificationPage.showDialgSucess(this.context,result.upperCamelCase+" ","Success");
      }else if(result.compareToIgnoringCase("error")==0){
        CommonNotificationPage.showDialgSucess(this.context,result.upperCamelCase, " Error ");
      }
    }
  }
