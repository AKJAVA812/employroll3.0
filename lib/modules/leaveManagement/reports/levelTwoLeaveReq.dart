...
class LevelTwoPendingLeave extends StatefulWidget {
  ...
  State<LevelTwoPendingLeave> createState() =>
      _LevelTwoPendingLeaveState(pendingLeaveRequisitionModal);
}
...
class _LevelTwoPendingLeaveState extends State<LevelTwoPendingLeave>
    with RouteAware {
  final LevelTwoPendingLeaveModal pendingLeaveRequisitionModal;
  _LevelTwoPendingLeaveState(this.pendingLeaveRequisitionModal);
    ...
    return RefreshIndicator(
      onRefresh: () {
        Navigator.pushReplacement(
          ...
          PageRouteBuilder(
            pageBuilder:
                (a, b, c) => LevelTwoPendingLeave(LevelTwoPendingLeaveModal()),
          ...
          return InkWell(
            onTap: () {
              ...
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder:
                      (context) => LevelTwoPendingApproval(
