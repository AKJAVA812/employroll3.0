...
class ApprovedLeaveRequisitionList extends StatefulWidget {
  ...
  @override
  State<ApprovedLeaveRequisitionList> createState() => _ApprovedLeaveRequisitionListState(approvedLeaveReqModal);
}
...
class _ApprovedLeaveRequisitionListState extends State<ApprovedLeaveRequisitionList> with RouteAware{
  final ApprovedLeaveReqModal approvedLeaveReqModal;
  ...
  Future<ApprovedLeaveReqModal> getApprovedLeaveReqList(String SessionId) async {
      ...
      Container(
        child: Column(
          children: [
            ...
            Expanded(
                child: approvedLeaveReqLabel == null ?
                Center(
                  ...
                  child: Container(
                    child: Column(
                      children: [
                        Row(
                          children: [
                            approvedLeaveReqModal.result!.data![i].employeeName.toString().text.make().px8().py4(),
                            Expanded(
                                child: Column(
                        ...
                        Row(
                          children: [
                            approvedLeaveReqModal.result!.data![i].applicationDate.toString().text.textStyle(context.captionStyle).make().px8(),
                            Expanded(
                                child: Column(
                                  mainAxisAlignment: MainAxisAlignment.end,
                                  crossAxisAlignment: CrossAxisAlignment.end,
                                  children: [
                                    approvedLeaveReqModal.result!.data![i].leaveLength.toString().text.make().px8(),
                                  ],
                                )
                            )
                          ],
                        ...
                        Row(
                          children: [
                            approvedLeaveReqModal.result!.data![i].leaveType.toString().text.textStyle(context.captionStyle).make().px8(),
                          ],
                        ),
                        Row(
                          ...
                          children: [
                            Column(
                              children: [
                                ...
                                approvedLeaveReqModal.result!.data![i].startDate.toString().text.sm.make()
                              ],
                            ),
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  approvedLeaveReqModal.result!.data![i].endDate.toString().text.sm.make()
                                ],
                              ),
                            ),
                            Column(
                              children: [
                                ...
                                approvedLeaveReqModal.result!.data![i].approvedBy.toString().text.sm.make()
                              ],
                            ),
                          ],
                        )
