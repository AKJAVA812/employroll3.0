...
class LevelTwoPendingApproval extends StatefulWidget {
  ...
  LevelTwoPendingApproval(this.pendingLeaveRequisitionModal, this.itemCount, {super.key});

  @override
  State<LevelTwoPendingApproval> createState() =>
      _LevelTwoPendingApprovalState(pendingLeaveRequisitionModal, itemCount);
}
        ...
        TextButton(
          onPressed: () {
            /*Navigator.pop(
                ...
                PageRouteBuilder(
                  pageBuilder: (a, b, c) =>
                      LevelTwoPendingLeave(LevelTwoPendingLeaveModal()),
                  transitionDuration: Duration(seconds: 1),
                  maintainState: true,
                ));*/
            Navigator.of(context, rootNavigator: true).pop();
            Navigator.pushNamed(buildContext, MyRoutings.levelTwoPendingRoute);
          },
          child: Text("Ok"),
        ),
      ],
