...
class LevelOnePendingLeave extends StatefulWidget {
  final LevelOnePendingLeaveModal pendingLeaveRequisitionModal;
  const LevelOnePendingLeave(this.pendingLeaveRequisitionModal, {super.key});

  @override
  State<LevelOnePendingLeave> createState() =>
      _LevelOnePendingLeaveState(pendingLeaveRequisitionModal);
}
...
class _LevelOnePendingLeaveState extends State<LevelOnePendingLeave>
    with RouteAware {
  final LevelOnePendingLeaveModal pendingLeaveRequisitionModal;
  _LevelOnePendingLeaveState(this.pendingLeaveRequisitionModal);
  @override
    ...
    return RefreshIndicator(
      onRefresh: () {
        Navigator.pushReplacement(
          ...
          PageRouteBuilder(
            pageBuilder:
                (a, b, c) => LevelOnePendingLeave(LevelOnePendingLeaveModal()),
