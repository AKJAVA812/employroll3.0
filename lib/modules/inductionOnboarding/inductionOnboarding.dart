  ...
  Widget build(BuildContext context) {
    ...
    return DismissKeyboard(
      child: Scaffold(
        appBar: AppBar(
          actions: [
            "Bharat Rajora".text.size(14).bold.color(Mythemes.dangerColor).make().px(10)
          ],
                                ...
                                child: Expanded(
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      //labelText: "Select Department",
                                      hintText: "Aadhar Registered Mobile No.",
                                      labelText: "Aadhar Registered Mobile No.",
                                      hintStyle: TextStyle(
                                        fontSize: 14,
                                      ),
                                      contentPadding: EdgeInsets.all(5),
                              ...
                              child: DropdownButtonFormField(
                                /*disabledHint: Container(
                                  ...
                                  items: [
                                    DropdownMenuItem(
                                      child:
                                      Text('Male',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 1,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Female',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 2,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Others',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 3,
                                    ),
                              ...
                              child: DropdownButtonFormField(
                                /*disabledHint: Container(
                                  ...
                                  items: [
                                    ...
                                    DropdownMenuItem(
                                      child:
                                      Text('Contract',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 1,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Permanent',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 2,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Probationer',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 3,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Temporary',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 4,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Trainee',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 5,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Regular',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 6,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Contractual',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 7,
                                    ),
                                  ],
                                  onChanged: (int? value) {
                              ...
                              child: DropdownButtonFormField(
                                /*disabledHint: Container(
                                  ...
                                  items: [
                                    ...
                                    DropdownMenuItem(
                                      child:
                                      Text('Single',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 1,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Married',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 2,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Divorced',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 3,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Widowed',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 4,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text("Domestic Partner",style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 5,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Separated',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 6,
                                    ),
                            ...
                            child: Expanded(
                              child: DropdownButtonFormField(
                                /*disabledHint: Container(
                                  ...
                                  items: onboardDeptList.map<DropdownMenuItem<String>>((String? value) {
                                    return DropdownMenuItem<String>(
                                      value: value,
                                      child: Text(value! , style: TextStyle(fontSize: 9), maxLines: 2),
                                    );
                                ...
                                onChanged: (newVal) {
                                  ...
                                  for(int i=0; i<onboardDeptListModal!.data!.length;i++){
                                    if(onboardDeptListModal!.data![i].name.toString().compareToIgnoringCase(newVal.toString()) ==0)
                                    {
                                      deptId = onboardDeptListModal!.data![i].id!.toString();
                            ...
                            child: Expanded(
                              child: DropdownButtonFormField(
                                /*disabledHint: Container(
                                  ...
                                  items: onboardDesignationList.map<DropdownMenuItem<String>>((String? value) {
                                    return DropdownMenuItem<String>(
                                      value: value,
                                      child: Text(value! , style: TextStyle(fontSize: 9), maxLines: 2),
                                    );
                          ...
                          Visibility(
                            ...
                            child: Expanded(
                              child: DropdownButtonFormField(
                                  ...
                                  items: onboardBranchList.map<DropdownMenuItem<String>>((String? value) {
                                    return DropdownMenuItem<String>(
                                      value: value,
                                      child: Text(value! , style: TextStyle(fontSize: 9), maxLines: 2),
                                    );
                                ...
                                onChanged: (newVal) {
                                  ...
                                  for(int i=0; i<onboardBranchListModal!.data!.length;i++){
                                    if(onboardBranchListModal!.data![i].name.toString().compareToIgnoringCase(newVal.toString()) ==0)
                                    {
                            ...
                            child: Expanded(
                              child: DropdownButtonFormField(
                                /*disabledHint: Container(
                                  ...
                                  items: onboardUserTypeList.map<DropdownMenuItem<String>>((String? value) {
                                    return DropdownMenuItem<String>(
                                      value: value,
                                      child: Text(value! , style: TextStyle(fontSize: 9), maxLines: 2),
                                    );
                              ...
                              child: DropdownButtonFormField(
                                /*disabledHint: Container(
                                  ...
                                  items: [
                                    ...
                                    DropdownMenuItem(
                                      child:
                                      Text('Skilled',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 1,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Semi Skilled',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 2,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Unskilled',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 3,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Technical',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 4,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Non Technical',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 5,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Skill Non Defined',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 6,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Highly Skilled',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 7,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Chargehand',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 8,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('HighlySkilled',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 9,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Senior Supervisor',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 10,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Supervisor',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 11,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Functional',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 12,
                                    ),
                                  ],
                                  onChanged: (int? value) {
                                    setState(() {
                                      ...
                                      print("Skill Type Drop - $skillTypeDrop");
                                      print("Skill Type Name - $skillTypeName");
                                    });
                                  }
                      ...
                      Row(
                        ...
                        children: [
                          isLoading
                              ...
                              : onboardDocTypeListModal == null || onboardDocTypeListModal!.data!.isEmpty
                              ? Center(child: Text('No data available')) :
                          Expanded(
                            child: ListView.builder(
                                scrollDirection: Axis.vertical,
                                shrinkWrap: true,
                                itemCount: onboardDocTypeListModal!.data!.length,
                                itemBuilder: (context, itemCount) {
                                  return Card(
                                    child: ListTile(
                                      title: Text(onboardDocTypeListModal!.data![itemCount].name
                                          .toString()),
                                      subtitle: Text(
                                        uploadedDocuments.containsKey(itemCount)
                              ...
                              child: DropdownButtonFormField(
                                /*disabledHint: Container(
                                  ...
                                  items: [
                                    ...
                                    DropdownMenuItem(
                                      child:
                                      Text('Aadhar Card (Front)',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 1,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Aadhar Card (Back)',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 2,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Pan Card',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 3,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Police Verification',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 4,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Medical Certificate',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 5,
                                    ),
                                    DropdownMenuItem(
                                      child:
                                      Text('Employee Photo',style: TextStyle(overflow: TextOverflow.ellipsis , fontSize: 13)) ,
                                      value: 6,
                                    ),
                            ...
                            Expanded(
                              child:  TextFormField(
                                onTap: () async{
                                  ...
                                  setState(() {
                                    //singleDateString = DateFormat('dd-MM-yyyy').format(date!);
                                    _toDateController.text = DateFormat("dd-MM-yyyy").format(fromDate!);
                                  });
...
// Add dynamic documents (if any)
    for (int i = 0; i < uploadedDocuments.length; i++) {
      String docType = onboardDocTypeListModal!.data![i].name ?? "unknownDocType";
      String filePath = uploadedDocuments[i] ?? "";

      if (filePath.isNotEmpty && File(filePath).existsSync()) {
        try {
          var file = await http.MultipartFile.fromPath('docs[$docType]', filePath); // Use dynamic key
