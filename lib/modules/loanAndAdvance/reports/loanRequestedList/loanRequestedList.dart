...
class PendingLoanRequestedList extends StatefulWidget {
  ...
  @override
  State<PendingLoanRequestedList> createState() => _PendingLoanRequestedListState(loanAdvanceReqModal);
...
class _PendingLoanRequestedListState extends State<PendingLoanRequestedList> with RouteAware{
  final LoanAdvanceReqModal loanAdvanceReqModal;
  ...
  Future getSharedPrfanceList() async {
    ...
    getAppReq11.then((value) {
      ...
      print('employeeList00${loanAdvanceReqModalGlobal!.loanRequiDatalist!.length}');
    });
  }
                        ...
                        children: [
                          ...
                          Expanded(
                              child: Column(
                                ...
                                children: [
                                  foundDataNew![i].remark!.text.textStyle(context.captionStyle).make(),
                                ],
                              )
                        ...
                        children: [
                          ...
                          Expanded(
                              child: Column(
                                ...
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: [
                                  foundDataNew![i].raisedBy!.text.textStyle(context.captionStyle).make(),
                                ],
                              )
