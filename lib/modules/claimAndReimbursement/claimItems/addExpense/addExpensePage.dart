...
class _AddExpensePageState extends State<AddExpensePage> {
  ...
  Future getSharedPrfanceList() async {
    ...
    Future<AddExpDropPolicyModal> getAppReq11 = getReimbursementTypeList(sessionId!);
  ...
  Future<AddExpDropPolicyModal> getReimbursementTypeList(String SessionId) async {
    list = [];
    newList = [];
    policyList=[];
 ...
 List categoryItemlist = [];
                ...
                children: [
                  ...
                  value: dropdownvalue,
                    ...
                    items: newList.map<DropdownMenuItem<String>>((String? value) {
                      final truncatedValue = value!.length > 18 ? value.substring(0, 18) + '...' : value;
                          ...
                          child: DropdownButtonFormField(
                              value: dropdownvalueType,
                                decoration: InputDecoration(
                                  ...
                                  // labelText: "Location",
                                  labelStyle: TextStyle(
                                      fontWeight: FontWeight.w500,fontSize: 12,overflow: TextOverflow.ellipsis,
                                      color: Mythemes.blackish),
                                ),
                                items: expList.map<DropdownMenuItem<String>>((String? value) {
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    ...
                                    expIdNew = mapResponse['expenseDataList'][i]['expenseId'];
                      ...
                      Expanded(
                          child: DropdownButtonFormField(
                            value: subExpDropType,
                                ...
                                items: subExpList.map<DropdownMenuItem<String>>((String? value) {
                                  // Truncate the value if it exceeds a certain length
                                  final truncatedValue = value!.length > 18 ? value.substring(0, 18) + '...' : value;
                                  return DropdownMenuItem<String>(
                                    value: value,
                              ...
                              onChanged: (value) {
                                ...
                                setState(() {
                                  ...
                                  subExpId = mapResponse['subExpDataList'][i]['subExpId'];
                                  print('SUB EXPENSE ID -  $subExpId');

                                  for(int j=0; j<addExpensesDropsLabel!.catDataList!.length;j++){

                                    catSubExpId = addExpensesDropsLabel!.catDataList![j].subExpId;
                                    if(subExpId == addExpensesDropsLabel!.catDataList![j].subExpId ){
                                      print("Category Subexp Id - $catSubExpId");
                                      catList.add(addExpensesDropsLabel!.catDataList![j].catName);
                                    }
                          ...
                          child:  DropdownButtonFormField(
                              ...
                              onChanged: (value) {
                                setState(() {
                                  ...
                                  for(int j=0; j<addExpensesDropsLabel!.catDataList!.length;j++){
                                    catId = addExpensesDropsLabel!.catDataList![j].catId;
                                    print('cat ID -  $catId');
                                  }
  ...
  async {
    ...
    var uri = Uri.parse("http://www.employroll.com/restful/service/claim/requisition/form/details/save");
