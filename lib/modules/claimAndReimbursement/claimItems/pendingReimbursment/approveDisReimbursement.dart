...
class ApproveDisappReimbursement extends StatefulWidget {
  ...
  @override
  State<ApproveDisappReimbursement> createState() =>  _ApproveDisappReimbursementState(pendingReimbListModal, i);
}

class _ApproveDisappReimbursementState extends State<ApproveDisappReimbursement> {
  PendingReimbListModal pendingReimbListModal;
  int i;
                ...
                children: [
                      ...
                      Expanded(
                        child: DropdownButtonFormField(
                            disabledHint: Container(
                              width: 150,
                              child: reimpType.toString().text.size(13).overflow(TextOverflow.ellipsis).make(),
                            ),
                            decoration: InputDecoration(
                              enabled: false,
                              enabledBorder: UnderlineInputBorder( //<-- SEE HERE
                    ...
                    children: [
                      Expanded(
                        child: DropdownButtonFormField(
                            disabledHint: Container(
                              width: 120,
                              child: expName.toString().text.size(13).overflow(TextOverflow.ellipsis).make(),
                            ),
                            decoration: InputDecoration(
                              enabled: false,
                              enabledBorder: UnderlineInputBorder( //<-- SEE HERE
                            ...
                            items: [
                              ...
                              DropdownMenuItem(
                                child:
                                Container(
                                  child: "Conveyance".text.size(13).overflow(TextOverflow.ellipsis).make(),
                                ),
                                value: 1,
                              ),
                      ...
                      Expanded(
                        child: DropdownButtonFormField(
                            disabledHint: Container(
                              width: 120,
                              child: subExpName.toString().text.size(13).overflow(TextOverflow.ellipsis).make(),
                            ),
                            decoration: InputDecoration(
                              enabled: false,
                              enabledBorder: UnderlineInputBorder( //<-- SEE HERE
                            ...
                            items: [
                              ...
                              DropdownMenuItem(
                                ...
                                Container(
                                  width: 120,
                                  child: "Bike 2 Wheeler Local".text.size(13).overflow(TextOverflow.ellipsis).make(),
                                ),
                                value: 1,
                              ),
                              DropdownMenuItem(
                                child:
                                    Container(
                                      width: 120,
                                      child: "Cab Taxi".text.size(13).overflow(TextOverflow.ellipsis).make(),
                                    ),
                                value: 2,
                              ),
                    ...
                    children: [
                      Expanded(
                        child:  DropdownButtonFormField(
                            disabledHint: Container(
                              width: 120,
                              child: catName.toString().text.size(13).overflow(TextOverflow.ellipsis).make(),
                            ),
                            decoration: InputDecoration(
                              enabled: false,
                              enabledBorder: UnderlineInputBorder( //<-- SEE HERE
                            ...
                            items: [
                              DropdownMenuItem(
                                ...
                                Container(
                                  width: 120,
                                  child: "Employee Owned Bike".text.size(13).overflow(TextOverflow.ellipsis).make(),
                                ),
                                value: 1,
                              ),
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: TextFormField(
                          controller: TextEditingController(text: raisedAmt),
                          enabled: false,
                          // initialValue: "Head Office",
                          //maxLines: 3,
                          decoration: InputDecoration(
                      ...
                      ButtonBar(
                          ...
                          children: [
                            ElevatedButton(
                              onPressed: () {
                                status = "Approve";
                                approveReimbursementReq(_approvedAmtController.text, _remarksController.text);
                            ...
                            ElevatedButton(
                              onPressed: () {
                                status = "Disapprove";
                                disApproveReimbursementReq(_approvedAmtController.text, _remarksController.text);
