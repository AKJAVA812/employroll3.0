...
class TravelExpenseRequestRaise extends StatefulWidget {
  const TravelExpenseRequestRaise({super.key});

  @override
  State<TravelExpenseRequestRaise> createState() =>
...
class _TravelExpenseRequestRaiseState extends State<TravelExpenseRequestRaise> {
                    ...
                    Column(
                      ...
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: ["Add Claim".text.bold.size(16).make()],
                        ),
                        Row(
                          children: [
                            Expanded(
                              child:
                                  DropdownButtonFormField(
                                    value:
                                        cardData.dropdownValue.isEmpty
                                            ? null
                                            : cardData.dropdownValue,
                                    ...
                                    onChanged: (newVal) {
                                      ...
                                      for (
                                        int i = 0;
                                        i <
                                            reimbursementTypeListModal!
                                                .claimDataList!
                                                .length;
                                        i++
                                      ) {
                                        if (reimbursementTypeListModal!
                                                .claimDataList![i]
                                                .policyName
                                                .toString()
                            ...
                            Visibility(
                              ...
                              child: Expanded(
                                child:
                                    DropdownButtonFormField(
                                      value:
                                          cardData.catDropType.isEmpty
                                              ? null
                                              : cardData.catDropType,
                                      decoration: InputDecoration(
                                        enabledBorder: UnderlineInputBorder(
                                          //<-- SEE HERE
                                          borderSide: BorderSide(
                            ...
                            Visibility(
                              ...
                              child: Expanded(
                                child:
                                    DropdownButtonFormField(
                                      value:
                                          cardData.subCatDropType.isEmpty
                                              ? null
                                              : cardData.subCatDropType,
                                      decoration: InputDecoration(
                                        enabledBorder: UnderlineInputBorder(
                                          //<-- SEE HERE
                                          borderSide: BorderSide(
                            ...
                            children: [
                              Expanded(
                                child:
                                    DropdownButtonFormField(
                                      value:
                                          cardData.subSubCatDropType.isEmpty
                                              ? null
                                              : cardData.subSubCatDropType,
                                      decoration: InputDecoration(
                                        enabledBorder: UnderlineInputBorder(
                                          //<-- SEE HERE
                                          borderSide: BorderSide(
                            ...
                            children: [
                              Expanded(
                                child:
                                    TextFormField(
                                      controller:
                                          cardData.odometerStartController,
                                      enabled: true,
                                      // initialValue: "Head Office",
                                      //maxLines: 3,
                              ...
                              Expanded(
                                child:
                                    TextFormField(
                                      controller:
                                          cardData.odometerEndController,
                                      enabled: true,
                                      // initialValue: "Head Office",
                                      //maxLines: 3,
                                      keyboardType: TextInputType.number,
                              ...
                              child: Expanded(
                                child:
                                    TextFormField(
                                      ...
                                      controller:
                                          cardData.monthController.text.isEmpty
                                              ? null
                                              : cardData.monthController,
                                      onChanged: (value) {
                                        //value = cardData.fromPlaceController.text;
                              ...
                              Expanded(
                                child:
                                    TextFormField(
                                      controller:
                                          cardData
                                                  .claimedAmtController
                                                  .text
                                                  .isEmpty
                                              ? null
                                              : cardData.claimedAmtController,
                                      enabled: true,
                                      // initialValue: "Head Office",
                                      //maxLines: 3,
                                      keyboardType: TextInputType.number,
