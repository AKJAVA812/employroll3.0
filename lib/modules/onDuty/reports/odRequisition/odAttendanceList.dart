...
class ODAttendanceList extends StatefulWidget {
  const ODAttendanceList({super.key});
            ...
            child: Container(
              child: Column(
                children: [
                  Row(
                    children: [
                      attendanceModelGlobel!.data![itemCount].employeeName!.text
                          .make()
                          .px8()
                          .py4(),
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            attendanceModelGlobel!.data![itemCount].status!.text
                                .make()
                                .px8(),
                          ],
                        ),
