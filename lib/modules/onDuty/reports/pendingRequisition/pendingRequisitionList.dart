...
import '../onDutyTypes.dart';
import 'modalClass/pendingOdReqList.dart';
import 'odAttendanceApproval.dart';

class PendingOdRequisition extends StatefulWidget {
  final PendingOdReqList pendingOdReqList;

  const PendingOdRequisition(this.pendingOdReqList, {super.key});

  @override
  State<PendingOdRequisition> createState() =>
      _PendingOdRequisitionState(pendingOdReqList);
}
