...
class LateInEmpList extends StatefulWidget {
  ...
  LateInEmpList(this.dashboardModelGlobal);
...
class _LateInEmpListState extends State<LateInEmpList> {
   ...
   List<LateInList> filteredEmployees = [];
  _LateInEmpListState(this.dashboardModelGlobal);
  @override
  void initState() {
    setState(() {
      filteredEmployees = dashboardModelGlobal?.lateInList ?? [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.5,
        actions: [
          "Total - ${dashboardModelGlobal!.lateInList!.length}".text.size(14).bold.color(Mythemes.warningColor).make().px(10)
        ],
      ),
  ...
  getPresentEmp(List<LateInList> employeeList){
                      ...
                      children: [
                        ...
                        Expanded(
                            child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.end,
                              children: [
                                employee.lateTime!.text.make().px8(),
