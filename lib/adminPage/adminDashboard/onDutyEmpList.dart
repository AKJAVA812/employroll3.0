...
class _OnDutyEmpListState extends State<OnDutyEmpList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: "On Duty Employees".text.make(),
        elevation: 0.5,
        actions: [
          "Total - ${dashboardModelGlobal!.workingList!.length}".text.size(14).bold.color(Mythemes.successColor).make().px(10)
        ],
      ),
  ...
  getPresentEmp(List<WorkingList> employeeList){
