...
class _MissPunchEmpListState extends State<MissPunchEmpList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.5,
        actions: [
          "Total - ${dashboardModelGlobal!.mispunchEmpSEt!.length}".text.size(14).bold.color(Mythemes.alertColor).make().px(10)
        ],
      ),
  ...
  getPresentEmp(List<MispunchEmpSEt> employeeList){
