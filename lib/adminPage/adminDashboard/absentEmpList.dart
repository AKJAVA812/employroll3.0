...
class _AbsentEmpListState extends State<AbsentEmpList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: "Absent Employees".text.make(),
        elevation: 0.5,
        actions: [
          "Total - ${dashboardModelGlobal!.absentEmp!.length}".text.size(14).bold.color(Mythemes.dangerColor).make().px(10)
        ],
      ),
  ...
  getPresentEmp(List<AbsentEmp> employeeList){
