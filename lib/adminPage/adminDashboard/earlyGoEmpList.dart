...
class _EarlyGoEmpListState extends State<EarlyGoEmpList> {
   ...
   List<EarlyOutList> filteredEmployees = [];
  _EarlyGoEmpListState(this.dashboardModelGlobal);
  @override
  void initState() {
    setState(() {
      filteredEmployees = dashboardModelGlobal?.earlyOutList ?? [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.5,
        actions: [
          "Total - ${dashboardModelGlobal!.earlyOutList!.length}".text.size(14).bold.color(Mythemes.warningColor).make().px(10)
        ],
      ),
  ...
  getPresentEmp(List<EarlyOutList> employeeList){
                      ...
                      children: [
                        ...
                        Expanded(
                            child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.end,
                              children: [
                                employee.earlyTime!.text.make().px8(),
