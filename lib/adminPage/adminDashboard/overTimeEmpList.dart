...
class _OverTimeEmpListState extends State<OverTimeEmpList> {
   ...
   List<OtEmpList> filteredEmployees = [];
  _OverTimeEmpListState(this.dashboardModelGlobal);
  @override
  void initState() {
    setState(() {
      filteredEmployees = dashboardModelGlobal?.otEmpList ?? [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: "Over Time Employees".text.make(),
        elevation: 0.5,
        actions: [
          "Total - ${dashboardModelGlobal!.otEmpList!.length}".text.size(14).bold.color(Mythemes.lightBluishColor).make().px(10)
        ],
      ),
  ...
  getPresentEmp(List<OtEmpList> employeeList){
