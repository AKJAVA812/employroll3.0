...
class AttendanceApprovalPageL2 extends StatefulWidget {
  PendingRequisitionModel pendingRequisitionModel;
  int itemCount;

  AttendanceApprovalPageL2(this.pendingRequisitionModel, this.itemCount, {super.key});

  @override
  State<AttendanceApprovalPageL2> createState() =>
      _AttendanceApprovalPageL2State(pendingRequisitionModel, itemCount);
}

class _AttendanceApprovalPageL2State extends State<AttendanceApprovalPageL2> {
  PendingRequisitionModel pendingRequisitionModel;
  int itemCount;

  _AttendanceApprovalPageL2State(this.pendingRequisitionModel, this.itemCount);
