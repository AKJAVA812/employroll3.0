...
class AttendanceApprovalPageL2 extends StatefulWidget {
  ...
  AttendanceApprovalPageL2(this.pendingRequisitionModel, this.itemCount);

  @override
  State<AttendanceApprovalPageL2> createState() => _AttendanceApprovalPageL2State(pendingRequisitionModel,itemCount);
}
