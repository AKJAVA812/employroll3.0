...
class MSS_Att_PendingRequisitionL1 extends StatefulWidget {
  final PendingRequisitionModel pendingRequisitionModel;
  const MSS_Att_PendingRequisitionL1(this.pendingRequisitionModel, {super.key});

  @override
  State<MSS_Att_PendingRequisitionL1> createState() =>
      _MSS_Att_PendingRequisitionL1State(pendingRequisitionModel);
}
...
class _MSS_Att_PendingRequisitionL1State
    extends State<MSS_Att_PendingRequisitionL1>
    with RouteAware {
  final PendingRequisitionModel pendingRequisitionModel;
                  ...
                  onTap: () {
                    if (foundDataNewMSS![itemCount].shortLeaveRequistionType ==
                      ...
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder:
                              (context) => ShortLeaveApprovalPage(
                      ...
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder:
                              (context) => AttendanceApprovalPageL1(
                                pendingRequisitionModel,
                                itemCount,
                              ),
                        ),
