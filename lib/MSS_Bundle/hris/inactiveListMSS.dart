...
class InactiveListMSS extends StatefulWidget {
  ...
  @override
  State<InactiveListMSS> createState() => _InactiveListMSSState();
}
...
String? orgId;
dynamic matchedOrg;
class _InactiveListMSSState extends State<InactiveListMSS> with RouteAware{
  @override
  ...
  var titleName = "Inactive Employees";
  int value = 1;
