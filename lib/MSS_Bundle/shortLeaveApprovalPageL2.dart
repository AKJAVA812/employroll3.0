...
class ShortLeaveApprovalL2Page extends StatefulWidget {
  ...
  ShortLeaveApprovalL2Page(this.pendingRequisitionModel, this.itemCount, {super.key});

  @override
  State<ShortLeaveApprovalL2Page> createState() =>
      _ShortLeaveApprovalL2PageState(pendingRequisitionModel, itemCount);
}

class _ShortLeaveApprovalL2PageState extends State<ShortLeaveApprovalL2Page>
    with RouteAware {
  PendingRequisitionModel pendingRequisitionModel;
  int itemCount;
