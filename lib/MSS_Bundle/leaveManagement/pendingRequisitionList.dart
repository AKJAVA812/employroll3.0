...
class MSS_PendingLeaveRequisitionList extends StatefulWidget {
  ...
  const MSS_PendingLeaveRequisitionList(this.pendingLeaveRequisitionModal, {super.key});

  @override
  State<MSS_PendingLeaveRequisitionList> createState() =>
      _MSS_PendingLeaveRequisitionListState(pendingLeaveRequisitionModal);
}
...
class _MSS_PendingLeaveRequisitionListState
    extends State<MSS_PendingLeaveRequisitionList>
    with RouteAware {
  final PendingLeaveRequisitionModal pendingLeaveRequisitionModal;
    ...
    return RefreshIndicator(
      onRefresh: () {
        Navigator.pushReplacement(
          ...
          PageRouteBuilder(
            pageBuilder:
                (a, b, c) => MSS_PendingLeaveRequisitionList(
