...
class MSS_PendingLeaveRequisitionList extends StatefulWidget {
  final PendingLeaveRequisitionModal pendingLeaveRequisitionModal;
  const MSS_PendingLeaveRequisitionList(this.pendingLeaveRequisitionModal);


  @override
  State<MSS_PendingLeaveRequisitionList> createState() => _MSS_PendingLeaveRequisitionListState(pendingLeaveRequisitionModal);
}
...
class _MSS_PendingLeaveRequisitionListState extends State<MSS_PendingLeaveRequisitionList> with RouteAware{
  final PendingLeaveRequisitionModal pendingLeaveRequisitionModal;
  _MSS_PendingLeaveRequisitionListState(this.pendingLeaveRequisitionModal);
    ...
    return RefreshIndicator(
      onRefresh: () {
        Navigator.pushReplacement(
            ...
            PageRouteBuilder(
              pageBuilder: (a, b, c) =>
                  MSS_PendingLeaveRequisitionList(PendingLeaveRequisitionModal()),
                  ...
                  child: Container(
                    child: Column(
                      children: [
                        Row(
                          children: [
                            foundDataNewMSS![itemCount].employeeName.toString().text.make().px8().py4(),
                            Expanded(
                                child: Column(
                                  mainAxisAlignment: MainAxisAlignment.end,
                                  crossAxisAlignment: CrossAxisAlignment.end,
                                  children: [
                                    foundDataNewMSS![itemCount].status.toString().text.make().px8(),
                                  ],
                                )
                            )
                        ...
                        Row(
                          children: [
                            foundDataNewMSS![itemCount].leaveType.toString().text.textStyle(context.captionStyle).make().px8(),
                          ],
                        ),
                        Row(
                          children: [
                            foundDataNewMSS![itemCount].leaveLength.toString().text.textStyle(context.captionStyle).make().px8(),
                          ],
                        ),
                        Row(
                          ...
                          children: [
                            Column(
                              children: [
                                ...
                                foundDataNewMSS![itemCount].startDate.toString().text.sm.make()
                              ],
                            ),
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  foundDataNewMSS![itemCount].endDate.toString().text.sm.make()
                                ],
                              ),
                            ),
                            Column(
                              children: [
                                ...
                                foundDataNewMSS![itemCount].startTime.toString().text.sm.make()
                              ],
                            ),
                            Padding(
                              padding: const EdgeInsets.only(top: 15, left: 5, right: 3, bottom: 18),
                              child: Column(
                                children: [
                                  ...
                                  foundDataNewMSS![itemCount].endTime.toString().text.sm.make()
                                ],
                              ),
                            ),
                          ],
