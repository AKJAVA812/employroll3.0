...
class MSS_LevelOnePendingLeave extends StatefulWidget {
  ...
  @override
  State<MSS_LevelOnePendingLeave> createState() => _MSS_LevelOnePendingLeaveState(pendingLeaveRequisitionModal);
}
...
List<Data>? foundDataNewMSSL1=[];

LevelOnePendingLeaveModal? pendingLeaveReqLabel;
LevelOnePendingLeaveModal? pendingLeaveReqLabeled;

class _MSS_LevelOnePendingLeaveState extends State<MSS_LevelOnePendingLeave> with RouteAware{
  final LevelOnePendingLeaveModal pendingLeaveRequisitionModal;
  _MSS_LevelOnePendingLeaveState(this.pendingLeaveRequisitionModal);
  @override
        ...
        child: SafeArea(
          child: Container(
            ...
            child: AnimationSearchBar(
                ...
                centerTitle: "$titleName - ${foundDataNewMSSL1!.length}",
                verticalPadding: 3,
