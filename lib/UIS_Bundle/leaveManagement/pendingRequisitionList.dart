...
class UIS_PendingLeaveRequisitionList extends StatefulWidget {
  ...
  State<UIS_PendingLeaveRequisitionList> createState() =>
      _UIS_PendingLeaveRequisitionListState(pendingLeaveRequisitionModal);
}
...
class _UIS_PendingLeaveRequisitionListState
    extends State<UIS_PendingLeaveRequisitionList>
    with RouteAware {
  final PendingLeaveRequisitionModal pendingLeaveRequisitionModal;
    ...
    return RefreshIndicator(
      onRefresh: () {
        Navigator.pushReplacement(
          ...
          PageRouteBuilder(
            pageBuilder:
                (a, b, c) => UIS_PendingLeaveRequisitionList(
