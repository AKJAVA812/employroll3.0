...
class _UIS_PendingOdRequisitionState extends State<UIS_PendingOdRequisition>
    with RouteAware {
  final PendingOdReqList pendingOdReqList;
    ...
    return RefreshIndicator(
      onRefresh: () {
        Navigator.pushReplacement(
          ...
          PageRouteBuilder(
            pageBuilder:
                (a, b, c) => UIS_PendingOdRequisition(PendingOdReqList()),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(
                          child:
                              foundDataNewUIS![itemCount].odaddress
                                  .toString()
                                  .text
                          ...
                          child: Column(
                            children: [
                              ...
                              DateFormat("dd-MM-yyyy")
                                  .format(
                                    DateTime.parse(
                                      foundDataNewUIS![itemCount].date
                                          .toString(),
                                    ),
                                  )
                                  .text
