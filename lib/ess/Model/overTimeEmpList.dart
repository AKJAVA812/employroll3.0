...
class OverTimeEmpList extends StatefulWidget {
  final EssDashboarrdModel dashboardModelGlobal;

  const OverTimeEmpList(this.dashboardModelGlobal, {super.key});


  @override
  State<OverTimeEmpList> createState() => _OverTimeEmpListState(dashboardModelGlobal);
}
dynamic itemCount = "";
class _OverTimeEmpListState extends State<OverTimeEmpList> {
  EssDashboarrdModel? dashboardModelGlobal;

  _OverTimeEmpListState(this.dashboardModelGlobal);
  @override
  void initState() {
    setState(() {
    });
  ...
  getPresentEmp(EssDashboarrdModel dashboardModel){
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, itemCount) {
        //var distance =dashboardModelGlobal!.otEmpList![itemCount].distance;
              ...
              child: Container(
                child: Column(
                  children: [
                    Row(
                      children: [
                        dashboardModelGlobal!.countData!.shortLeaveList![itemCount].empName!.text.make().px8().py4(),
                        Expanded(
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.end,
                              crossAxisAlignment: CrossAxisAlignment.end,
                              children: [
                                "Short Leave By".text.make().px8(),
                              ],
                            )
                        )
                      ],
                    ...
                    Row(
                      children: [
                        dashboardModelGlobal!.countData!.shortLeaveList![itemCount].logDate!.text.bold.textStyle(context.captionStyle).make().px8(),
                        Expanded(
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.end,
                              crossAxisAlignment: CrossAxisAlignment.end,
                              children: [
                                dashboardModelGlobal!.countData!.shortLeaveList![itemCount].inTime!.text.make().px8(),
                    ...
                    Row(
                      children: [
                        dashboardModelGlobal!.countData!.shortLeaveList![itemCount].dept!.text.textStyle(context.captionStyle).make().px8(),
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            dashboardModelGlobal!.countData!.shortLeaveList![itemCount].inTime!.text.sm.make()
                          ],
                        ),
                        Padding(
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              dashboardModelGlobal!.countData!.shortLeaveList![itemCount].outTime!.text.sm.make()
                            ],
                          ),
                        ),
                        Padding(
                       ...
                       /* Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              dashboardModelGlobal!.otEmpList![itemCount].workingHours!.text.sm.make()
                            ],
                          ),
                        ),*/
                      ],
