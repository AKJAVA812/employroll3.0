...
class HalfDayEmpList extends StatefulWidget {
  ...
  const HalfDayEmpList(this.dashboardModelGlobal, {super.key});
...
class _HalfDayEmpListState extends State<HalfDayEmpList> {
  ...
  getPresentEmp(EssDashboarrdModel dashboardModel){
    itemCount = dashboardModelGlobal?.countData?.halfDayList?.length ?? 0;
    return ListView.builder(
      padding: const EdgeInsets.all(4.0),
      itemCount: itemCount,
      itemBuilder: (context, itemCount) {
        //var distance =dashboardModelGlobal!.halfDayEmpSet![itemCount].distance;
              ...
              child: Container(
                child: Column(
                  children: [
                    Row(
                      children: [
                        dashboardModelGlobal!.countData!.halfDayList![itemCount].empName!.text.make().px8().py4(),
                        Expanded(
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.end,
                              crossAxisAlignment: CrossAxisAlignment.end,
                              children: [
                                dashboardModelGlobal!.countData!.halfDayList![itemCount].status!.text.make().px8(),
                              ],
                            )
                        )
                      ],
                    ...
                    Row(
                      children: [
                        dashboardModelGlobal!.countData!.halfDayList![itemCount].logDate!.text.bold.textStyle(context.captionStyle).make().px8(),
                        /*Expanded(
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.end,
                              crossAxisAlignment: CrossAxisAlignment.end,
                    ...
                    Row(
                      children: [
                        dashboardModelGlobal!.countData!.halfDayList![itemCount].dept!.text.textStyle(context.captionStyle).make().px8(),
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            dashboardModelGlobal!.countData!.halfDayList![itemCount].inTime!.text.sm.make()
                          ],
                        ),
                        Padding(
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              dashboardModelGlobal!.countData!.halfDayList![itemCount].outTime!.text.sm.make()
                            ],
                          ),
                        ),
                        Padding(
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              dashboardModelGlobal!.countData!.halfDayList![itemCount].workingHours!.text.sm.make()
                            ],
                          ),
                        ),
                      ],
