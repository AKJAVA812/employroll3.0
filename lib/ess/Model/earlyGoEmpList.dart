...
class EarlyGoEmpList extends StatefulWidget {
  ...
  const EarlyGoEmpList(this.dashboardModelGlobal, {super.key});


  @override
  State<EarlyGoEmpList> createState() => _EarlyGoEmpListState(dashboardModelGlobal);
}
dynamic itemCount = "";

class _EarlyGoEmpListState extends State<EarlyGoEmpList> {
  EssDashboarrdModel? dashboardModelGlobal;

  _EarlyGoEmpListState(this.dashboardModelGlobal);
  @override
  void initState() {
    setState(() {
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: "Early Go Employees".text.make(),
        elevation: 0.5,
        actions: [
          IconButton(
              onPressed: () {
  ...
  getPresentEmp(EssDashboarrdModel dashboardModel){
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, itemCount) {
        //var distance =dashboardModelGlobal!.countData!.data![itemCount].presentList![itemCount]..toString();
              ...
              child: Container(
                child: Column(
                  children: [
                    Row(
                      children: [
                        dashboardModelGlobal!.countData!.earlyGoList![itemCount].empName!.text.make().px8().py4(),
                        Expanded(
                            child: Column(
                    ...
                    Row(
                      children: [
                        dashboardModelGlobal!.countData!.earlyGoList![itemCount].logDate!.text.bold.textStyle(context.captionStyle).make().px8(),
                        Expanded(
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.end,
                              crossAxisAlignment: CrossAxisAlignment.end,
                              children: [
                                dashboardModelGlobal!.countData!.earlyGoList![itemCount].inTime!.text.make().px8(),
                    ...
                    Row(
                      children: [
                        dashboardModelGlobal!.countData!.earlyGoList![itemCount].dept!.text.textStyle(context.captionStyle).make().px8(),
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            dashboardModelGlobal!.countData!.earlyGoList![itemCount].inTime!.text.sm.make()
                          ],
                        ),
                        Padding(
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              dashboardModelGlobal!.countData!.earlyGoList![itemCount].outTime!.text.sm.make()
                            ],
                          ),
                        ),
                        Padding(
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              dashboardModelGlobal!.countData!.earlyGoList![itemCount].workingHours!.text.sm.make()
                            ],
                          ),
                        ),
                      ],
