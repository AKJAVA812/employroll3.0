...
class MissPunchEmpList extends StatefulWidget {
  ...
  @override
  State<MissPunchEmpList> createState() => _MissPunchEmpListState(dashboardModelGlobal);
}
dynamic itemCount = "";
class _MissPunchEmpListState extends State<MissPunchEmpList> {
  EssDashboarrdModel? dashboardModelGlobal;

  _MissPunchEmpListState(this.dashboardModelGlobal);
  @override
  void initState() {
    setState(() {
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: "Misspunch Employees".text.make(),
        elevation: 0.5,
        actions: [
          IconButton(
              onPressed: () {
              ...
              child: Container(
                child: Column(
                  children: [
                    Row(
                      children: [
                        dashboardModelGlobal!.countData!.mispunchList![index].empName!.text.make().px8().py4(),
                        Expanded(
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.end,
                              crossAxisAlignment: CrossAxisAlignment.end,
                              children: [
                                dashboardModelGlobal!.countData!.mispunchList![index].logDate!.text.make().px8(),
                              ],
                            )
                        )
                      ],
                    ...
                    Row(
                      children: [
                        dashboardModelGlobal!.countData!.mispunchList![index].branch!.text.textStyle(context.captionStyle).make().px8(),

                      ],
                    ),
                    Row(
                      children: [
                        dashboardModelGlobal!.countData!.mispunchList![index].dept!.text.textStyle(context.captionStyle).make().px8(),
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            dashboardModelGlobal!.countData!.mispunchList![index].inTime!.text.sm.make()
                          ],
                        ),
                        Padding(
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              dashboardModelGlobal!.countData!.mispunchList![index].outTime!.text.sm.make()
                            ],
                          ),
                        ),
                        Padding(
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              dashboardModelGlobal!.countData!.mispunchList![index].workingHours!.text.sm.make()
                            ],
                          ),
                        ),
                      ],
